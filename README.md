...
```
git clone https://github.com/RockefellerArchiveCenter/internal_digitization_validation.git
cd internal_digitization_validation
docker build -t internal_digitization_validation .
docker run internal_digitization_validation
```
...
This repository is intended to be deployed as an ECS Task in AWS or local infrastructure.
